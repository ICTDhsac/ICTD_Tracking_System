<?php
	...
	function generateRow($from, $to, $fullname, $conn){
		...
		$sql = "SELECT * from task where (BucketName='Completed' OR BucketName='In Progress') ORDER BY AssignedTo ASC, DueDate DESC";
		...
		*/
		...
		$sql = "SELECT * from task WHERE ((StartDate BETWEEN '$from' AND '$to') OR (DueDate BETWEEN '$from' AND '$to')) AND (BucketName='Completed' OR BucketName='In Progress') ORDER BY AssignedTo ASC, DueDate DESC";	
		...
		*/
		...
		$sql = "SELECT * from task WHERE ((StartDate BETWEEN '$from' AND '$to') OR (DueDate BETWEEN '$from' AND '$to')) AND (BucketName='Completed' OR BucketName='In Progress') AND AssignedTo like '%$fullname%'  ORDER BY DueDate DESC";
		/*	
		...
		$ca = $rowca['totalca'];	
		*/
		$sqltask = "SELECT count(*) as totaltask FROM task WHERE ((StartDate BETWEEN '$from' AND '$to') OR (DueDate BETWEEN '$from' AND '$to')) AND (BucketName='Completed' OR BucketName='In Progress') AND AssignedTo like '%$fullname%'";
	...
	$sql = "SELECT * FROM task where DueDate<>'' AND (BucketName='Completed' OR BucketName='In Progress') ORDER BY DueDate ASC LIMIT 1";
	$query = $conn->query($sql);
	$row = $query->fetch_assoc();	
	$from_title = $row['DueDate'];
	
	$sql = "SELECT * FROM task where DueDate<>'' AND (BucketName='Completed' OR BucketName='In Progress') ORDER BY DueDate DESC LIMIT 1";
	$query = $conn->query($sql);
	$row = $query->fetch_assoc();	
