<?php
	...
	function generateRow($from, $to, $fullname, $conn){
		...
		$sql = "SELECT * from task where (BucketName='Completed') ORDER BY AssignedTo ASC, CompletedDate DESC";
		//echo $sql;	
		/*	
		...
		*/
		...
		$sql = "SELECT * from task WHERE StartDate BETWEEN '$from' AND '$to' AND (BucketName='Completed') ORDER BY AssignedTo ASC, CompletedDate DESC";	
		//echo $sql;
		/*
		...
		*/
		...
		$sql = "SELECT * from task WHERE StartDate BETWEEN '$from' AND '$to' AND (BucketName='Completed') AND AssignedTo like '%$fullname%'  ORDER BY CompletedDate DESC";
		/*	
		...
		$ca = $rowca['totalca'];	
		*/
		$sqltask = "SELECT count(*) as totaltask FROM task WHERE StartDate BETWEEN '$from' AND '$to' AND (BucketName='Completed') AND AssignedTo like '%$fullname%'";
		...
		*/	
		...
		while($row = $query->fetch_assoc()){
			...
			if ($label=="Support on Operation-Monitoring"){
				$sm = $sm + $interval; 
			}
			if ($label=="Support on Operation-Backup"){
				$sb = $sb + $interval; 
			}
			if ($label=="Production"){
				$pro = $pro + $interval; 
			}
			if (($label=="Information Dissemination") || ($label=="Support on Operation-Information Dissemination")){
				$id = $id + $interval; 
			}
			if ($label=="Inventory"){
				$inv = $inv + $interval; 
		...
		$contents .= '
			...
			<tr>
				<td  colspan="2" align="left"><b>&nbsp;</b></td>
				<td  colspan="2" align="right"><b>&nbsp;</b></td>
				<td  colspan="3" align="right" style="color:blue;"><b>Support on Operation-Information Dissemination</b></td>
				<td  colspan="1" align="right"><b>'.number_format($id, 0).'</b></td>
			</tr>
			<tr>
				<td  colspan="2" align="left"><b>&nbsp;</b></td>
				<td  colspan="2" align="right"><b>&nbsp;</b></td>
				<td  colspan="3" align="right" style="color:blue;"><b>Support on Operation-Backup</b></td>
				<td  colspan="1" align="right"><b>'.number_format($sb, 0).'</b></td>
			</tr>
			<tr>
				<td  colspan="2" align="left"><b>&nbsp;</b></td>
				<td  colspan="2" align="right"><b>&nbsp;</b></td>
				<td  colspan="3" align="right" style="color:blue;"><b>Support on Operation-Monitoring</b></td>
				<td  colspan="1" align="right"><b>'.number_format($sm, 0).'</b></td>
			</tr>
			<tr>
				<td  colspan="2" align="left"><b>&nbsp;</b></td>
				<td  colspan="2" align="right"><b>&nbsp;</b></td>
			...
			<tr>
				...
				<td  colspan="1" align="right"><b>'.number_format($ch+$cs+$cn+$co+$pro+$id+$so+$sm+$sb, 0).'</b></td>
			</tr>
			<tr>
				<td  colspan="2" align="left"><b>&nbsp;</b></td>
				<td  colspan="2" align="right"><b>&nbsp;</b></td>
	...
	$sql = "SELECT * FROM task where CompletedDate<>'' AND (BucketName='Completed') ORDER BY CompletedDate ASC LIMIT 1";
	$query = $conn->query($sql);
	$row = $query->fetch_assoc();	
	$from_title = $row['DueDate'];
	
	$sql = "SELECT * FROM task where CompletedDate<>'' AND (BucketName='Completed') ORDER BY CompletedDate DESC LIMIT 1";
	$query = $conn->query($sql);
	$row = $query->fetch_assoc();	
		
	$from_to = $row['CompletedDate'];
